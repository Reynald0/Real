...
class Alumno(models.Model): #Se crea el objeto Alumno, en la base de datos es una tabla
    ...
    edad = models.IntegerField() #Atributo edad es tipo de dato Integer
    carrera = models.CharField(max_length=90) #Atributo carrera es tipo de dato Char y su tamanio maximo es 80
